    ...
    <div className="mx-12 flex flex-col items-center lg:mx-0">
      ...
      <div className="relative text-center">
        <svg
          ...
          viewBox="0 0 512 512"
          fill="currentColor"
          className="absolute left-0 top-0 h-8 w-8 dark:text-gray-700"
        >
      ...
      <span className="my-2 h-1 w-12 rounded-lg dark:bg-violet-400"></span>
      <p>{authorName}</p>
    </div>
  );
}
...
export default function Testimonials({ data }: TestimonialsProps) {
  return (
    <section className="m:py-12 lg:py-24 dark:bg-black dark:text-gray-100">
